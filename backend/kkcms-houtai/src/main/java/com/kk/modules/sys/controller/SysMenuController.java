...
import com.kk.modules.sys.service.SysMenuService;
...
public class SysMenuController extends AbstractController {
	 ...
	 */
	@GetMapping("/nav")
	public R nav(HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		List<SysMenuEntity> menuList = sysMenuService.getUserMenuList(getUserId());
		Set<String> permissions = rbacService.getUserPermissions(getUserId());
