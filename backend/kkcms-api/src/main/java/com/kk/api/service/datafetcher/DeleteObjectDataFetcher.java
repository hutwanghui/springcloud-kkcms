 ...
 */
@Component
public class DeleteObjectDataFetcher<T> implements DataFetcher<T> {
    @Autowired
    ...
    public T get(DataFetchingEnvironment environment) {
        ...
        String chooseService = StringUtils.substringAfterLast(path, "delete");
        if (chooseService.equals("Comment")) {
            commentService.delete(environment.getArgument("comment"));
